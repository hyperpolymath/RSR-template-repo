...
:experimental:
:url-github: https://github.com/hyperpolymath/RSR-template-repo
:url-gitlab: https://gitlab.com/hyperpolymath/RSR-template-repo
:url-bitbucket: https://bitbucket.org/hyperpolymath/RSR-template-repo
:url-codeberg: https://codeberg.org/hyperpolymath/RSR-template-repo

RSR template repository for new projects
...
RSR-template-repo is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
